                      ...
                      return (
                        <button
                          ...
                          className={[
                            ...
                            selected
                              ? 'bg-white shadow-[0_1px_3px_rgba(15,28,46,0.08)] border border-black/[0.08]'
                        ...
                        >
                          ...
                          <div className="flex flex-col gap-0.5">
                            <span className={['text-sm font-medium font-sans', selected ? 'text-[var(--ink-900)]' : 'text-[var(--ink-800)]'].join(' ')}>
                              {label}
                            </span>
